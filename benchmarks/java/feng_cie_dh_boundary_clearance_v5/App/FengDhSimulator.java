...
public final class FengDhSimulator {
    ...
    public long step(int traceSampleModulo) {
        ...
        // Released sources and off-edge transfer timers choose an exit.
        ...
        // Zero through completes once; total transfer ready time is unchanged.
        ...
        // Clear physical cells only at goals or completed body clearance,
        ...
        for (NodeServiceProposal proposal : approvedNodeServices.values()) {
            ...
            if (throughTicks == 0L) {
                continue; // Through completed; body clearance was started above.
            }
    ...
    private long boundaryClearanceTicks(int upstreamEdgeId) {
