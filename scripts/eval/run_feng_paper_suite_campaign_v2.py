"""Continue the frozen V5 paper suite in qualified, resumable stages.
...
PLAN = ROOT / "outputs/evidence/paper_suite_20260907/frozen_plan_v5/plan.json"
PLAN_SHA = "00a95b47298fb1aac808bec9275f6d9b3c28d340859017c0667e39ff736b9719"
...
class Campaign:
    def __init__(self, plan_path, wait_seconds=WAIT_SECONDS):
        ...
        require(pool.sha(self.plan_path) == PLAN_SHA, "only the fixed V5 plan is authorized")
