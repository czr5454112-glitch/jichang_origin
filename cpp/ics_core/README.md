...
Paper-grade high-throughput scheduler validation, real heldout-map event parity, active-bag rolling replanning, recursive PIBT-style resolver, and broad runtime replay validation are still pending.
