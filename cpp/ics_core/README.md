...
Paper-grade high-throughput scheduler validation, real heldout-map event parity, full active-bag PIBT-style replay integration, merge-group/buffer semantics, and broad runtime replay validation are still pending.
