...
// set until a real one-hop service opportunity exists.  Their names are kept
// for artifact compatibility; priority is selected independently through
// DestinationMergeGrantRule rather than inferred from the timing label.
