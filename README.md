...
- Phase0/Phase1 legacy source fixation, map/task parsing, Python reference simulator, C++ core smoke parity, and explicit Java-compatible parsing for the ragged `example1/map.txt` heuristic fixture with Python/C++ A* parity.
