...
- Phase9 early runtime scaling and unified baseline-comparison diagnostics compare Python/native C++ event replay throughput and surface existing Phase2/Phase5/Phase8 baseline evidence in one table.
