...
- Phase9 early runtime scaling, matched baseline-comparison, repeated matched-family timing with local hardware metadata/95% CIs, and unified evidence diagnostics compare Python/native C++ throughput and surface existing Phase2/Phase5/Phase8 baseline evidence in one table.
