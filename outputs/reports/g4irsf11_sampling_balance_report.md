...
| Metric | Value |
| --- | --- |
| input_decision_count | 26731 |
| eligible_hard_case_count_before_dedupe | 10585 |
| routine_decision_count_excluded | 16146 |
| unique_hard_case_count_after_dedupe | 10585 |
...
| maximum_retained_candidate_rows | 9420 |
...
Trace shard completeness: `PASS` (stored=26731, seen=29356).

## Hard-case reason coverage before deduplication

| Reason | Count |
| --- | --- |
| downstream_pressure | 3734 |
| fallback_or_shield_selected | 494 |
| local_fault_state | 14 |
| local_queue_pressure | 925 |
| low_model_margin | 158 |
| model_fallback_disagreement | 488 |
| p95_tail | 1020 |
| p99_tail | 266 |
| risk_gate_triggered | 488 |
| rule:pibt_lite_safe_handoff | 488 |
| rule:predicted_candidate_allowed | 6 |
| source_queue_delay | 8695 |
| source_queue_long_backlog | 8695 |

## Largest strata

| Scenario | Scale | Source | Goal | Junction | Fault | Reason | Tail | Total | Unique | Quota | Weight |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| trace_highflow_2p5 | 2.5 | 52 | 49 | 30 | no_fault | source_queue_delay+source_queue_long_backlog | body | 181 | 181 | 64 | 2.82812 |
| trace_fault_delayed | 2.5 | 52 | 49 | 30 | fault_scenario_inactive_here | source_queue_delay+source_queue_long_backlog | body | 181 | 181 | 64 | 2.82812 |
...
| trace_highflow_4p0 | 4.0 | 52 | 49 | 30 | no_fault | source_queue_delay+source_queue_long_backlog | body | 163 | 163 | 64 | 2.54688 |
| trace_highflow_4p0 | 4.0 | 52 | 49 | 31 | no_fault | source_queue_delay+source_queue_long_backlog | body | 162 | 162 | 64 | 2.53125 |
| trace_fault_delayed | 2.5 | 52 | 49 | 29 | fault_scenario_inactive_here | source_queue_delay+source_queue_long_backlog | body | 139 | 139 | 64 | 2.17188 |
| trace_highflow_2p5 | 2.5 | 52 | 49 | 29 | no_fault | source_queue_delay+source_queue_long_backlog | body | 139 | 139 | 64 | 2.17188 |
| trace_highflow_4p0 | 4.0 | 52 | 49 | 29 | no_fault | source_queue_delay+source_queue_long_backlog | body | 124 | 124 | 64 | 1.9375 |
...
| trace_highflow_2p5 | 2.5 | 52 | 50 | 30 | no_fault | source_queue_delay+source_queue_long_backlog | body | 92 | 92 | 64 | 1.4375 |
| trace_fault_delayed | 2.5 | 52 | 50 | 30 | fault_scenario_inactive_here | source_queue_delay+source_queue_long_backlog | body | 92 | 92 | 64 | 1.4375 |
| trace_fault_delayed | 2.5 | 52 | 50 | 31 | fault_scenario_inactive_here | source_queue_delay+source_queue_long_backlog | body | 87 | 87 | 64 | 1.35938 |
| trace_highflow_4p0 | 4.0 | 52 | 50 | 31 | no_fault | source_queue_delay+source_queue_long_backlog | body | 87 | 87 | 64 | 1.35938 |
| trace_highflow_2p5 | 2.5 | 52 | 50 | 31 | no_fault | source_queue_delay+source_queue_long_backlog | body | 87 | 87 | 64 | 1.35938 |
