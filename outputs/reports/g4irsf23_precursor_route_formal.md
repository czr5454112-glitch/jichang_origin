# G4IRSF23 precursor Route Formal

Status: **NO_GO_PRECURSOR_FORMAL_SUPPORT**

The Formal panel reuses the existing G22 S4/J2/E2 runtime and exact G21 Route action seam.
...
- attempted groups: 2048
- complete H_bag groups: 2048
- complete H_system groups: 256
- action-changing groups: 2048 (1.000)
...
## Pilot reuse and exact coverage

- Pilot groups reused without replay: 512
- new H_bag-only Formal groups: 1536
- new H_system groups: 0
- total H_bag complete groups: 2048
- sparse reused H_system groups: 256 (not 2048)
- total H_bag-only groups: 1792
- exact execution pairs: 4096 (1024 reused + 3072 new)
- exact pair gate: PASS_EXACT_PAIR_GATE
- raw pair payloads remain runtime-only

## Tiny-MLP unlock (separate from Formal support)

- Formal fair positives: 6 / 40
- held-out fair positives: 0 / 12 (NOT_RUN)
- stable nonlinear regret evidence: NOT_RUN
- unlocked: false
