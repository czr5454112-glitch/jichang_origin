...
def main():
    ...
    for cell in CELLS:
        ...
        try:
            ...
            result = runner.load_completed(directory)
            with gzip.open(directory / "native_payload.json.gz", "rt", encoding="utf-8") as stream:
                native = runner._decode(json.load(stream))
